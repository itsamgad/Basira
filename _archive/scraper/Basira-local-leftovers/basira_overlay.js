// basira_overlay.js — injected into target page by basira_scraper.py
// Logo data URL is templated in at startup (see basira_scraper.py).
(function() {
  var _logoUrl = 'data:image/png;base64,__BASIRA_LOGO_BASE64__';
